        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-6 col-4">
                    <div class="logo">
                        <a href="index-3.php">
                            <img alt="" src="assets/img/logo/rishi trader logo.png">
                        </a>
                    </div>
                </div>
                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php"> GALLERY <i class="fa fa-angle-down"></i> </a>
                                        <ul class="mega-menu">
                                            <li>
                                                <ul>
                                                    <li class="mega-menu-title"><a href="#">Categories</a></li>
                                                    <li><a href="shop.php">Hardware</a></li>
                                                    <li><a href="shop.php">Garments</a></li>
                                                    <li><a href="shop.php">FMGC</a></li>
                ...
                <div class="mobile-menu">
                    <nav id="mobile-menu-active">
                        <ul class="menu-overflow">
                            ...
                            <li><a href="about-us.html">About</a></li>
                            <li><a href="shop.php">Gallery</a>
                                <ul>
                                    <li><a href="#">Categories</a>
                                        <ul>
                                            <li><a href="shop.php">Hardware</a></li>
                                            <li><a href="shop.php">Garments</a></li>
                                            <li><a href="shop.php">FNGC</a></li>
                                            <!-- <li><a href="shop.html">Glue sticks</a></li>
                                            <li><a href="shop.html">Lunchbox </a></li>
                                            <li><a href="shop.html">Pencil box </a></li> -->
                                        </ul>
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-4 pt-100 pb-95" style="background-image:url(assets/img/bg/breadcrumb-bg-4\ \(2\).jpg);">
        <div class="container">
            <h2>OUR GALLERY</h2>
            <p>Our Gallery was created to showcase our design team’s hard work, and showcase our expertly crafted pieces.</p>
        </div>
    </div>
                        ...
                        <div id="shop-1" class="tab-pane active">
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/pexels-los-muertos-crew-8447845.jpg" alt=""></a>
                                            <span>Sale</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-hardware (2).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-hardware (3).jpg" alt=""></a>
                                            <span>New</span>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-hardware (4).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-garments (1).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-garments (2).jpg" alt=""></a>
                                            <span>Sale</span>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-garments (3).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-garments (4).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-FMGC (1).jpg" alt=""></a>
                                            <span>Sale</span>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-FMGC (2).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-FMGC (3).jpg" alt=""></a>
                                            <span>New</span>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="product-wrap mb-30">
                                        <div class="product-img">
                                            <a href="#"><img src="assets/img/product/Gal-FMGC (4).jpg" alt=""></a>
                                            <div class="product-action">
                                                <!-- <ul>
                                                    <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                                    <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                        ...
                        <div id="shop-2" class="tab-pane">
                            <div class="shop-list-wrap mb-30">
                                <div class="shop-list-img">
                                    <a href="#"><img src="assets/img/product/Gal-List (1).jpg" alt=""></a>
                                </div>
                            ...
                            <div class="shop-list-wrap mb-30">
                                <div class="shop-list-img">
                                    <a href="#"><img src="assets/img/product/Gal-List (2).jpg" alt=""></a>
                                </div>
                                <div class="shop-list-content">
                            ...
                            <div class="shop-list-wrap mb-30">
                                <div class="shop-list-img">
                                    <a href="#"><img src="assets/img/product/Gal-List (3).jpg" alt=""></a>
                                </div>
                                <div class="shop-list-content">
                                    <h4><a href="#">Nut Screws</a></h4>
                                    <span>$500</span>
                                    <div class="review-rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="shop-list-wrap mb-30">
                                <div class="shop-list-img">
                                    <a href="#"><img src="assets/img/product/Gal-List (5).jpg" alt=""></a>
                                </div>
                                <div class="shop-list-content">
                                    <h4><a href="#">Winter Clothing</a></h4>
                                    <span>$500</span>
                                    <div class="review-rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="shop-list-wrap mb-30">
                                <div class="shop-list-img">
                                    <a href="#"><img src="assets/img/product/Gal-List (4).jpg" alt=""></a>
                                </div>
                                <div class="shop-list-content">
...
<footer class="footer-area">
    <div class="footer-top bg-img default-overlay pt-130 pb-80" style="background-image:url(assets/img/bg/bg4.jpg);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="footer-widget mb-40">
                        ...
                        <div class="footer-gallery">
                            <ul>
                                <li><a href="#"><img src="assets/img/gallery/F-Gallery (1).jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/gallery/F-Gallery (2).jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/gallery/F-Gallery (3).jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/gallery/F-Gallery (4).jpg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="footer-bwt-logo"  >
                    <img src="./assets/img/logo/bwt-white.png" alt="error">
                </div>
